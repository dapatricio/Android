...
public class Actividad_Informacion extends ActionBarActivity implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad__informacion);
        ...
        ArrayAdapter<String> adp = new ArrayAdapter<String>(Actividad_Informacion.this, android.R.layout.simple_list_item_1, opciones);
        ...
        ActionBar.Tab tab = actionBar.newTab().setText("Informacion").setTabListener(this);
        actionBar.addTab(tab);

        tab = actionBar.newTab().setText("Videos").setTabListener(this);
        actionBar.addTab(tab);
        ...
        menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        Toast.makeText(Actividad_Informacion.this, "Inicio", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 1:
                        Toast.makeText(Actividad_Informacion.this, "Informacion / Videos", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 2:
                        Toast.makeText(Actividad_Informacion.this, "Redes Sociales / Contactanos", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 3:
                        Toast.makeText(Actividad_Informacion.this, "Centros de Salud del Ecuador", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 4:
                        Toast.makeText(Actividad_Informacion.this, "Bienvenido al Chat en Linea", Toast.LENGTH_SHORT).show();
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int arg0) {
            switch (arg0) {
                case 0:
                    return new Fragment_Informacion();
                case 1:
                    return new Fragment_Videos();
                default:
                    return null;
            }
        }
