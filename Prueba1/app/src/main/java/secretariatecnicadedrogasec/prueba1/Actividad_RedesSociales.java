...
public class Actividad_RedesSociales extends ActionBarActivity implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad__redes);
        ...
        mainLayout = (LinearLayout) findViewById(R.id.mainLayout3);
        ...
        ArrayAdapter<String> adp = new ArrayAdapter<String>(Actividad_RedesSociales.this, android.R.layout.simple_list_item_1, opciones);
        ...
        ActionBar.Tab tab = actionBar.newTab().setText("Redes Sociales").setTabListener(this);
        actionBar.addTab(tab);

        tab = actionBar.newTab().setText("Contactanos").setTabListener(this);
        actionBar.addTab(tab);
        ...
        menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        Toast.makeText(Actividad_RedesSociales.this, "Inicio", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 1:
                        Toast.makeText(Actividad_RedesSociales.this, "Informacion / Videos", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 2:
                        Toast.makeText(Actividad_RedesSociales.this, "Redes Sociales / Contactanos", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 3:
                        Toast.makeText(Actividad_RedesSociales.this, "Centros de Salud del Ecuador", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 4:
                        Toast.makeText(Actividad_RedesSociales.this, "Bienvenido al Chat en Linea", Toast.LENGTH_SHORT).show();
