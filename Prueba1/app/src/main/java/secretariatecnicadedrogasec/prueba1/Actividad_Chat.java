...
/**
 * Created by dapat on 27/09/2016.
 */

public class Actividad_Chat extends ActionBarActivity implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad__chat);
        ...
        mainLayout = (LinearLayout) findViewById(R.id.mainLayout5);
        ...
        ArrayAdapter<String> adp = new ArrayAdapter<String>(Actividad_Chat.this, android.R.layout.simple_list_item_1, opciones);
        ...
        Actividad_Chat.PagerAdapter adapter = new Actividad_Chat.PagerAdapter(getSupportFragmentManager());
        mViewPager = (ViewPager) findViewById(R.id.pager5);
        ...
        ActionBar.Tab tab = actionBar.newTab().setText("Chat en Linea").setTabListener(this);
        ...
        menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        Toast.makeText(Actividad_Chat.this, "Inicio", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 1:
                        Toast.makeText(Actividad_Chat.this, "Informacion / Videos", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 2:
                        Toast.makeText(Actividad_Chat.this, "Redes Sociales / Contactanos", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 3:
                        Toast.makeText(Actividad_Chat.this, "Centros de Salud del Ecuador", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case 4:
                        Toast.makeText(Actividad_Chat.this, "Bienvenido al Chat en Linea", Toast.LENGTH_SHORT).show();
